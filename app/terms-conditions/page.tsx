      ...
      <main className="flex-1 container py-12 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              This website is operated by ClassMent. Throughout the site, the terms "we", "us" and "our" refer to
              ClassMent. ClassMent offers this website, including all information, tools and services available from
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 6 - OPTIONAL TOOLS</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 7 - THIRD-PARTY LINKS</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 10 - ERRORS, INACCURACIES AND OMISSIONS</h2>
            <p>
            ...
            <p>
              In no case shall ClassMent, our directors, officers, employees, affiliates, agents, contractors, interns,
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 13 - INDEMNIFICATION</h2>
            <p>
              You agree to indemnify, defend and hold harmless ClassMent and our parent, subsidiaries, affiliates,
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 14 - SEVERABILITY</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 15 - TERMINATION</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 16 - ENTIRE AGREEMENT</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 17 - GOVERNING LAW</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 18 - CHANGES TO TERMS OF SERVICE</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">SECTION 19 - CONTACT INFORMATION</h2>
            <p>
